    ...
    return (
        <footer className='bg-gray-800'>
            ...
            <div className='max-w-6xl m-auto flex flex-col sm:flex-row justify-between pt-2 px-3 text-gray-500'>
                ...
                <a className='underline text-blue-400 my-auto py-2' href='mailto:randreu28@gmail.com'>randreu28@gmail.com</a>

                <div className='flex space-x-4 py-5'>
                    <a className='my-auto' href='https://www.behance.net/RubenChiquin' target='_blank' rel='noreferrer'>
                        <svg className='h-8 w-auto fill-current text-white hover:cursor-pointer hover:opacity-75 duration-200'
                    ...
                    <a className='my-auto' href='https://www.linkedin.com/in/rubén-chiquin-0a153721a/' target='_blank' rel='noreferrer'>
                        <svg className='h-8 w-auto fill-current text-white hover:cursor-pointer hover:opacity-75 duration-200'
                            xmlns='http://www.w3.org/2000/svg'
                            width='24'
                            height='24'
                    ...
                    <a className='my-auto' href='https://github.com/randreu28' target='_blank' rel='noreferrer'>
                        <svg className='h-8 w-auto fill-current text-white hover:cursor-pointer hover:opacity-75 duration-200'
                            xmlns='http://www.w3.org/2000/svg'
                            width='24'
                            height='24'

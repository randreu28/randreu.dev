...
export const index = {
  en: {
    ...
    proj2: (
      <>
        In the last years of my college degree, I worked at the{" "}
  ...
  es: {
    ...
    introText: (
      <>
        ...
        <br />
        <br />
        He trabajado en <i>startups</i>, universidades y en instituciones sin
        ánimo de lucro, siempre con temas relacionados con diseño, tecnología y
    ...
    proj2: (
      <>
        En mis últimos años de mi carrera, estuve trabajando en el{" "}
        <span className="font-bold underline decoration-yellow-400 decoration-wavy decoration-slice text-white">
        ...
        que eran recibidos desde Google Analytics y en hacer cambios conocorde a
        ellos para asegurar un buen UX.{" "}
      </>
    ),
    ...
    proj3: (
      <>
        Contrario a otras carreras, uno de los beneficios de estudiar una
        carrera con una gran base de diseño, es la oportunidad de enseñar{" "}
        <a
          href="https://www.behance.net/RubenChiquin"
          target="_blank"
          rel="noreferrer"
        ...
        a tu familia y amigos. Como resultado de ello, un amigo de un amigo, a
        quien le había enseñado mi trabajo me contactó por una oportunidad de
        negocios.
        <br />
        <br />
        ...
        en donde se me encargó manejar las diferentes cuentas de redes sociales,
        como su canal de Youtube y su blog, así como encargos de diseño, tales
        como banners, rollups y tarjetas de presentación.
      </>
    ),
  ...
  ca: {
    ...
    introText: (
      <>
        ...
        ànim de lucre, sempre en treball relacionat al disseny, la tecnologia i
        les eines digitals.
        <br />
        <br />
...
export const imaginePlanetChallenge = {
  en: {
...
export const projPrev = {
  en: {
    ...
    upcTitle: "Scholarship in the UPC",
    upcDescription: (
      <>
        In the last years of my college degree, I worked at the{" "}
        <span className="font-bold underline decoration-yellow-400 decoration-wavy decoration-slice text-white">
...
export const footer = {
  ...
  es: {
    text: "© Copyright 2020. Todos los derechos reservados.",
  },
  ca: {
    text: "© Copyright 2020. Tots els drets reservats.",
  },
};

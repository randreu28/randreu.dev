        ...
        <div className="items-center lg:flex">
          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-start space-y-5 md:space-y-0 mt-6 -mx-2 md:space-x-5">
              ...
              <div className="flex space-x-2 ring-gray-300 ring-2 text-gray-300 rounded-lg px-3 py-2 hover:text-my-pink hover:ring-my-pink duration-200 font-bold ml-2">

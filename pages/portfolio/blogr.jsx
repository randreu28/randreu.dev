      ...
      <div className="bg-white"> {/* Pseudo-body wrapper */}
        <div className="bg-Blogr h-screen rounded-bl-3xl rounded-bl-big p-5 font-extrabold">
          <nav className="flex justify-between">
            <div className="flex">
              <svg
                className="mx-5 hover:opacity-50 duration-300 cursor-pointer"
                width="101"
                height="40"
              ...
              <button className="lg:flex px-3 hover:opacity-50 duration-300 hidden">
                <p className="font-ubuntu text-white text-lg px-3 m-auto">
                  Product
                </p>
                <svg
                  className="m-auto"
            ...
            <div className="lg:flex hidden">
              <button className="font-ubuntu text-white text-lg rounded-3xl px-5 mx-2 hover:bg-BlogrLightRed duration-300">
                Login
              </button>
              <button className="font-ubuntu text-BlogrRed text-lg rounded-3xl bg-white px-5 mx-2 hover:bg-BlogrLightRed hover:text-white duration-300">
                Sign up
              </button>
            </div>
            <svg
              className="flex lg:hidden my-auto hover:opacity-50 duration-300 cursor-pointer"
              width="32"
              height="18"
              xmlns="http://www.w3.org/2000/svg"
            >
          ...
          <div className="m-auto h-full flex flex-col justify-center">
            <h1 className="font-overpass font-medium pb-3 md:pb-3 text-center text-white text-3xl md:text-5xl">
              A modern publishing platform
            </h1>
            <p className="font-overpass font-thin text-center text-white">
              Grow your audience and build your online brand
            </p>
            <div className="flex justify-center pt-10 flex-col sm:flex-row">
              <button className="font-ubuntu text-BlogrRed text-lg rounded-3xl bg-white px-5 py-1 mx-2 my-2 sm:my-0 hover:text-white hover:bg-BlogrLightRed duration-300">
                Start for free
              </button>
              <button className="font-ubuntu text-white text-lg ring-1 ring-white rounded-3xl px-5 py-1 mx-2 my-2 sm:my-0 hover:bg-white hover:ring-0 hover:text-BlogrRed duration-300">
                Learn more
              </button>
            </div>
          </div>
        </div>
        <h1 className="text-center text-BlogrDarkBlue font-overpass font-bold text-4xl pt-20 pb-5">
          Designed for the future
        </h1>
        <div className="flex flex-col lg:flex-row justify-evenly">
          <div className="lg:w-3/4 p-10 lg:p-5 self-center lg:pl-20">
          ...
          <img
            src="/media/illustration-editor-desktop.svg"
            alt="Blogr stuff"
            className="order-first lg:order-last self-center max-w-none w-full h-auto sm:max-w-lg xl:max-w-2xl"
          />
        </div>
        <br />
        <br />
        <div className="bg-Blogr1 rounded-bl-[6rem] rounded-tr-[6rem] flex flex-col lg:flex-row lg:h-72">
          <img
            className="self-center"
            src="/media/illustration-phones.svg"
            alt=""
          ></img>
          <div className="text-white self-center p-10 lg:p-5 lg:px-20 max-w-screen-xl">
            <h1 className="text-3xl font-overpass font-bold py-5 text-center lg:text-left">
        ...
        <br />
        <div className="flex flex-col lg:flex-row justify-evenly">
          <div className="lg:w-3/4 p-10 lg:p-5 self-center lg:pr-20">
            <h1 className="text-BlogrDarkBlue font-overpass font-medium text-3xl py-5 text-center lg:text-left">
              Free, open, simple
            </h1>
            <p className="font-overpass text-BlogrDarkishBlue text-center lg:text-left">
          ...
          <img
            src="/media/illustration-laptop-desktop.svg"
            alt="Blogr Laptop"
            className="order-first self-center max-w-none w-full h-auto sm:max-w-lg xl:max-w-3xl lg:transform lg:-translate-x-1/4"
          />
        </div>
        <br />
        <br />
        <footer className="bg-BlogrDarkishBlue font-overpass text-center text-white p-10 flex flex-col md:flex-row justify-between self-center rounded-tr-[6rem] px-20">
          <svg
            className="mx-5 mb-10 hover:opacity-50 duration-300 cursor-pointer self-center"
            width="101"
            height="40"
            xmlns="http://www.w3.org/2000/svg"
          >
          ...
          <div className="duration-300">
            <h1 className="font-bold py-5 text-2xl">Product</h1>
            <p className="py-1 hover:cursor-pointer hover:opacity-50 duration-300">
              Overview
            </p>
            <p className="py-1 hover:cursor-pointer hover:opacity-50 duration-300">
              Pricing
          ...
          <div className="duration-300">
            <h1 className="font-bold py-5 text-2xl">Company</h1>
            <p className="py-1 hover:cursor-pointer hover:opacity-50 duration-300">
              About
            </p>
            <p className="py-1 hover:cursor-pointer hover:opacity-50 duration-300">
          ...
          <div className="duration-300">
            <h1 className="font-bold py-5 text-2xl">Connect</h1>
            <p className="py-1 hover:cursor-pointer hover:opacity-50 duration-300">
              Contact
            </p>
            <p className="py-1 hover:cursor-pointer hover:opacity-50 duration-300">

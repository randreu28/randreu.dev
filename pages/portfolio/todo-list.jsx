...
export default function ToDoList() {
  ...
  function countHandler() {
    let count = todos.filter(
      (el) => !el.completed
    ); /* Filter all todos that are completed */
    return count.length;
  }
  ...
  useEffect(() => {
    document.getElementsByTagName("body")[0].classList =
      "bg-gray-100 font-josefin bg-ToDo md:bg-TodoBig";
  }, []);
  ...
  return (
    <>
      ...
      <div className="w-11/12 lg:w-1/3 m-auto pt-10">
        ...
        <form
          className="bg-white bg-opacity-20 p-4 rounded drop-shadow-xl flex mb-8"
        ...
        >
          ...
          <input
            className="pl-4 w-full focus:outline-none text-lg bg-transparent text-white"
            type="text"
            value={title}
        ...
        <ul
          className="bg-white bg-opacity-20 px-4 pt-2 rounded divide-y md:text-lg"
          id="taskList"
        >
          ...
          <div className="flex justify-between text-white p-3 text-sm">
            ...
            <p
              ...
              className=" hover:cursor-pointer hover:text-blue-400 duration-200 text-center"
            >
              Clear <br />
              Completed
            </p>
        ...
        <div className="flex flex-col sm:flex-row justify-center text-center m-auto bg-white bg-opacity-20  px-3 py-2 rounded my-8 space-y-5 sm:space-y-0 sm:space-x-10">
          <p
            ...
            className={
              status === "all"
                ? "text-blue-400"
                : "text-white hover:cursor-pointer hover:text-blue-400 duration-200"
            }
          >
            All
          </p>
